...
public class ChatServerGUI {
    ...
    public ChatServerGUI(int port) {
        ...
        JLabel header = new JLabel("Java Chat Server", JLabel.CENTER);
        ...
        try {
            ...
            appendMessage("Server started. Waiting for a client...\n", Color.GREEN);
            ...
            try {
                while ((message = in.readLine()) != null) {
                    try {
                        ...
                        appendMessage("Client: " + decryptedMessage, Color.ORANGE);
