...
. ├── ChatServerGUI.java # Server-side code with GUI and encryption ├── ChatClientGUI.java # Client-side code with GUI and encryption └── README.md # Project documentation
